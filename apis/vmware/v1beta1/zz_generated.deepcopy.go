...
func (in *VSphereMachineNetworkSpec) DeepCopyInto(out *VSphereMachineNetworkSpec) {
	*out = *in
	...
	if in.VLANs != nil {
		...
		*out = make(map[string]VSphereMachineNetworkVLANSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VSphereMachineNetworkVLANSpec) DeepCopyInto(out *VSphereMachineNetworkVLANSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VSphereMachineNetworkVLANSpec.
func (in *VSphereMachineNetworkVLANSpec) DeepCopy() *VSphereMachineNetworkVLANSpec {
	if in == nil {
		return nil
	}
	out := new(VSphereMachineNetworkVLANSpec)
	in.DeepCopyInto(out)
	return out
}
